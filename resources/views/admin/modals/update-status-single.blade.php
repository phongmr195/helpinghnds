                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="row">
                                <div class="col-sm-8">
                                    <select id="inputStatus" class="form-control custom-select js_select_status_single" name="status">
                                ...
                                <div class="col-sm-4 mt-mb-15">
                                    <button type="button" class="btn btn-sm btn-success form-control js_update_status_single" data-url="{{route('admin.users.update-status', ['user' => $item->id])}}">
                                        Update
                                    </button>
                                </div>
                            </div>
